!(function (e, t) {
      ...
      if (!r && (T(t), (t = t || C), E)) {
        ...
        if (
          ...
          if (((c = e), (f = t), 1 === p && (V.test(e) || X.test(e)))) {
            for (
              ((f = (ne.test(e) && ge(t.parentNode)) || t) === t && d.scope) ||
                ((s = t.getAttribute("id"))
                  ? (s = s.replace(ie, oe))
  ...
  (S.event = {
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          o = S.event.handlers.call(this, s, u), t = 0;
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          e = this || e;
          return (
            ce.test(e.type) && e.click && A(e, "input") && Ce(e, "click", xe),
            !1
          );
        },
        trigger: function (e) {
          e = this || e;
          return (
            ce.test(e.type) && e.click && A(e, "input") && Ce(e, "click"), !0
          );
        },
        _default: function (e) {
          e = e.target;
    ...
    if (
      ...
      for (s = (a = S.map(he(e, "script"), Ne)).length; c < f; c++)
        (u = e),
          ...
          i.call(n[c], u, c);
      if (s)
        for (l = a[a.length - 1].ownerDocument, S.map(a, je), c = 0; c < s; c++)
          (u = a[c]),
            pe.test(u.type || "") &&
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = Ke(s)), (a = S.cssHooks[t] || S.cssHooks[s]), void 0 === n)
        )
          ...
          return void 0 === e.getAttribute
            ...
            : ((1 === o && S.isXMLDoc(e)) ||
                (i =
                  ...
                  (S.expr.match.bool.test(t) ? yt : void 0)),
              void 0 !== n
                ? null === n
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : vt.test(e.nodeName) || (xt.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
      ...
      toggleClass: function (i, t) {
        ...
        return "boolean" == typeof t && a
          ...
          : this.each(function () {
              var e, t, n, r;
              if (a)
                for (t = 0, n = S(this), r = Tt(i); (e = r[t++]); )
                  n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
              else
                (void 0 !== i && "boolean" != o) ||
                  ((e = wt(this)) && Y.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
        ...
        if (
          ...
          try {
            (r.href = h.url),
              (r.href = r.href),
              (h.crossDomain =
                $t.protocol + "//" + $t.host != r.protocol + "//" + r.host);
          } catch (e) {
            h.crossDomain = !0;
          }
        }
  ...
  S.ajaxSetup({
    ...
    (v.createHTMLDocument =
      (((f = E.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    S.each(["top", "left"], function (e, n) {
      S.cssHooks[n] = Xe(v.pixelPosition, function (e, t) {
        if (t)
          return (t = Ue(e, n)), $e.test(t) ? S(e).position()[n] + "px" : t;
      });
    }),
  ...
  return (
    (S.noConflict = function (e) {
      return C.$ === S && (C.$ = Kt), e && C.jQuery === S && (C.jQuery = Jt), S;
    }),
